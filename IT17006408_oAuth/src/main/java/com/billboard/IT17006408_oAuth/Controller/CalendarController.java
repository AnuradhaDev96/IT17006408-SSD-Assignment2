...
//
//
//import com.billboard.IT17006408_oAuth.model.CalendarModel;
...
//
//            } catch (Exception e) {
//                model.addAttribute("calendarObjs", new ArrayList<CalendarModel>());
//            }
//
//            return "agenda";
//        } else {
...
//            try {
//
//                List<CalendarModel> calendarEventList = getTodaysCalendarEventList(code, redirectURIAvailableSlot);
//                List<CalendarModel> freeCalendarObjs = populateAvailableSlot(calendarEventList);
//
...
//    }
//
//    private List<CalendarModel> getTodaysCalendarEventList(String calenderApiCode, String redirectURL) {
//        try {
...
//
//            CalendarModel calendarObj;
//            List<CalendarModel> calendarObjs = new ArrayList<CalendarModel>();
//
...
//
//        } catch (Exception e) {
//            return new ArrayList<CalendarModel>();
//        }
//    }
//
//    private List<CalendarModel> populateAvailableSlot(List<CalendarModel> calendarEventList) {
//        int freeSlotStartHour = START_HOUR;
//        int freeSlotStartMin = START_MIN;
//        int freeSlotEndHour = END_HOUR;
//        int freeSlotEndMin = END_MIN;
//
//        CalendarModel freeCalEvent;
//        CalendarModel thisCalEvent;
//        CalendarModel nextCalEvent;
//        List<CalendarModel> freeCalendarObjs = new ArrayList<CalendarModel>();
//
...
//
//                    freeCalEvent = new CalendarModel();
//
